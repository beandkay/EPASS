...
from semilearn.datasets.utils import sample_labeled_data
...
def get_stl10(args, alg, name, num_labels, num_classes, data_dir='./data'):
    ...
    lb_data, lb_targets, _ = sample_labeled_data(args, lb_data, lb_targets, num_labels, num_classes)
    ulb_targets = None
    ...
    lb_dset = BasicDataset(alg, lb_data, lb_targets, num_classes, transform_weak, False, None, transform_strong, False)
